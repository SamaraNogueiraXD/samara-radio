...
<head>
    ...
    <title>Rádio 2º ANO MANHÃ</title>
...
<body>
    ...
    <audio controls src="sounds/aplausos.wav" id="som_tecla_aplausos"></audio>
    <audio controls src="sounds/vaia.wav" id="som_tecla_vaia"></audio>
    <audio controls src="sounds/risadas.wav" id="som_tecla_risada"></audio>
    <audio controls src="sounds/risadas.wav" id="som_tecla_risada"></audio>
    <audio controls src="sounds/errado.wav" id="som_tecla_errado"></audio>
    <audio controls src="sounds/grilo.wav" id="som_tecla_grilo"></audio>
    <audio controls src="sounds/tambores.wav" id="som_tecla_tambores"></audio>
    <audio controls src="sounds/trombeta.wav" id="som_tecla_trombeta"></audio>
    <audio controls src="sounds/dinheiro.wav" id="som_tecla_dinheiro"></audio>
    <audio controls src="sounds/vitoria.wav" id="som_tecla_vitoria"></audio>
    <script src="main.js"></script>
